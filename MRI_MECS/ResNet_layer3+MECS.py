...
"""
Brain Tumor MRI Baseline using ResNet50 + MECS (after layer3)
...
# =======================
def main():
    print("Starting Brain Tumor MRI ResNet50 + MECS (after layer3)...")
    ...
    best_path = "best_resnet50_mecs_layer3_brain_mri.pt"
