...
"""
Chest X-ray Pneumonia using ResNet50 + GCSA (after layer2)
...
# =======================
class EarlyStopping:
    def __init__(self, patience=7, delta=0.0, loss_delta=1e-4, save_path="best_resnet50_gcsa_layer2.pt"):
...
# =======================
def main():
    print("Starting Chest X-ray Pneumonia ResNet50 + GCSA(layer2) ...")
    ...
    model = ResNet50_GCSA_Layer2(num_classes=num_classes).to(device)
    ...
    best_path = "best_resnet50_gcsa_layer2_pneumonia.pt"
    ...
    print("\nChest X-ray Pneumonia ResNet50 + GCSA(layer2) completed!")
