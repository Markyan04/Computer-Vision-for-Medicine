...
"""Export HAM10000 test samples where baseline fails but proposed succeeds, using pytorch-grad-cam."""
...
from gradcam_shared import extract_logits, sanitize_filename, tensor_to_pil  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description='Export HAM10000 test-set Grad-CAM comparison samples with pytorch-grad-cam.')
    parser.add_argument('--class-name', help='True-label class name to filter, e.g. nv, mel, bkl.')
