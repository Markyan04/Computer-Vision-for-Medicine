...
"""
Knee Osteoarthritis Severity Grading Baseline using ResNet(layer3) + GCSA + DAST Loss
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_resnet50_gcsa_layer3_dast_knee_oa.pt"):
...
# =======================
# Custom Model: ResNet50 + GCSA (layer3)
# =======================
...
# =======================
def main():
    print("Starting ResNet(layer3)+GCSA+DAST Knee Osteoarthritis Baseline...")
    ...
    best_path = "best_resnet50_gcsa_layer3_dast_knee_oa.pt"
    ...
    print("\nResNet(layer3)+GCSA+DAST Knee Osteoarthritis baseline completed!")
