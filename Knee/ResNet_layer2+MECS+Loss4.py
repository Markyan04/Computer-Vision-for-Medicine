...
"""
Knee Osteoarthritis Severity Grading Baseline using ResNet(layer2) + MECS + DAST Loss
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_resnet50_mecs_layer2_dast_knee_oa.pt"):
...
class CustomResNet50MECS(nn.Module):
    def __init__(self, num_classes=5):
        ...
        # [MODIFIED]: MECS Module (Output of layer2 has 512 channels)
    ...
    def forward(self, x):
        ...
        # [MODIFIED]: Injecting MECS after layer 2
        x = self.mecs(x)
...
# =======================
def main():
    print("Starting ResNet(layer2)+MECS+DAST Knee Osteoarthritis Baseline...")
    ...
    print("Loading ResNet50 with MECS module...")
    ...
    best_path = "best_resnet50_mecs_layer2_dast_knee_oa.pt"
    ...
    print("\nResNet(layer2)+MECS+DAST Knee Osteoarthritis baseline completed!")
