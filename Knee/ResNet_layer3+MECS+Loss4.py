...
"""
Knee Osteoarthritis Severity Grading Baseline using ResNet(layer3) + MECS + DAST Loss
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_resnet50_mecs_layer3_dast_knee_oa.pt"):
...
# =======================
def main():
    print("Starting ResNet(layer3)+MECS+DAST Knee Osteoarthritis Baseline...")
    ...
    print("\nResNet(layer3)+MECS+DAST Knee Osteoarthritis baseline completed!")
