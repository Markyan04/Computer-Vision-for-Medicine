...
"""
Knee Osteoarthritis Severity Grading Baseline using ResNet(layer2) + GCSA + DAST Loss
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_resnet50_gcsa_dast_knee_oa.pt"):
...
class CustomResNet50GCSA(nn.Module):
    def __init__(self, num_classes=5):
        ...
        # [MODIFIED]: GCSA Module (Output of layer2 has 512 channels)
    ...
    def forward(self, x):
        ...
        # [MODIFIED]: Injecting GCSA after layer 2
        x = self.gcsa(x)
...
# =======================
def main():
    print("Starting ResNet(layer2)+GCSA+DAST Knee Osteoarthritis Baseline...")
    ...
    print("Loading ResNet50 with GCSA module...")
    ...
    best_path = "best_resnet50_gcsa_dast_knee_oa.pt"
    ...
    print("\nResNet(layer2)+GCSA+DAST Knee Osteoarthritis baseline completed!")
