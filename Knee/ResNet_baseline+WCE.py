...
ImageFolder split version (Weighted Cross-Entropy Loss, Hardcoded Class Names)
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_resnet50_knee_oa.pt"):
...
# Config
# =======================
DATA_ROOT = r"../Knee_Osteoarthritis"  # 改成你的路径
...
def main():
    ...
    # ===== 使用逆频率加权 (Inverse Frequency Weighted CE) =====
    ...
    best_path = "best_resnet50_knee_oa_wce.pt"
    ...
    print("\nKnee Osteoarthritis ResNet50 baseline completed!")
