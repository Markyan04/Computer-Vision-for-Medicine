...
"""
Knee Osteoarthritis Severity Grading Baseline using ResNet(layer2) + MECS + CE
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_resnet50_mecs_knee_oa.pt"):
...
# =======================
def main():
    print("Starting ResNet(layer2)+MECS+CE Knee Osteoarthritis Baseline...")
    ...
    best_path = "best_resnet50_mecs_layer2_knee_oa.pt"
    ...
    print("\nResNet(layer2)+MECS+CE Knee Osteoarthritis baseline completed!")
