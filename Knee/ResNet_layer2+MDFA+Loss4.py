...
"""
Knee Osteoarthritis Severity Grading Baseline using ResNet(layer2) + MDFA + DAST Loss
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_resnet50_mdfa_dast_knee_oa.pt"):
...
class CustomResNet50MDFA(nn.Module):
    def __init__(self, num_classes=5):
        ...
        # MDFA Module (Output of layer2 has 512 channels)
...
# =======================
def main():
    print("Starting ResNet(layer2)+MDFA+DAST Knee Osteoarthritis Baseline...")
    ...
    print("Loading ResNet50 with MDFA module...")
    ...
    best_path = "best_resnet50_mdfa_dast_knee_oa.pt"
    ...
    print("\nResNet(layer2)+MDFA+DAST Knee Osteoarthritis baseline completed!")
