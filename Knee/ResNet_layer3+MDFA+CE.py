...
"""
Knee Osteoarthritis Severity Grading Baseline using ResNet(layer3) + MDFA + CE
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_resnet50_mdfa_layer3_knee_oa.pt"):
...
# =======================
def main():
    print("Starting ResNet(layer3)+MDFA+CE Knee Osteoarthritis Baseline...")
    ...
    best_path = "best_resnet50_mdfa_layer3_knee_oa.pt"
    ...
    print("\nResNet(layer3)+MDFA+CE Knee Osteoarthritis baseline completed!")
