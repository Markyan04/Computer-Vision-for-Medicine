...
"""Draw Grad-CAM visualizations for Brain Tumor MRI checkpoints."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description='Draw Grad-CAM for a Brain Tumor MRI checkpoint.')
...
def main() -> None:
    ...
    module = load_script_module(script_path, prefix='brain_mri_gradcam')
