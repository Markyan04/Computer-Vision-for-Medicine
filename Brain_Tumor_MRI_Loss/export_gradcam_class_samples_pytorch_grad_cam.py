...
"""Export Grad-CAM visualizations for every Brain Tumor MRI test image of a chosen class."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description='Export Grad-CAM visualizations for all Brain Tumor MRI test images of a chosen class.'
    )
    parser.add_argument('--class-name', required=True, help='True-label class name to filter, e.g. glioma, meningioma, notumor, pituitary.')
...
def main() -> None:
    ...
    module = load_script_module(script_path, prefix='brain_mri_gradcam_class_pgc')
