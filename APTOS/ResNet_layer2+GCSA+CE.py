...
"""
APTOS 2019 Blindness Detection baseline using ResNet50 + GCSA (After Layer2) + CrossEntropy.
Adapted from the MDFA baseline.
...
- Custom insertion of GCSA module after layer2
...
# =======================
# Custom Model with GCSA
# =======================
class CustomResNet50WithGCSA(nn.Module):
    def __init__(self, num_classes=5, pretrained=True):
        super(CustomResNet50WithGCSA, self).__init__()
        ...
        self.gcsa = GCSA(in_channels=512, rate=4)
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_aptos2019_resnet50_gcsa_layer2_CE.pt"):
...
# =======================
def main():
    print("Starting APTOS2019 CustomResNet50+GCSA Baseline...")
    ...
    print("Loading CustomResNet50 with GCSA module (After Layer2)...")
    # 使用包含 GCSA 的自定义模型
    model = CustomResNet50WithGCSA(num_classes=NUM_CLASSES, pretrained=True)
    ...
    best_path = "best_aptos2019_resnet50_gcsa_layer2_CE.pt"
    ...
    print("\nAPTOS2019 ResNet50 + GCSA (Layer2) + CrossEntropy baseline completed!")
