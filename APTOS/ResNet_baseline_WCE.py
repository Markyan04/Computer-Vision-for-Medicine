...
"""
APTOS 2019 Blindness Detection baseline using ResNet50 and Weighted CE.
Adapted from the user's previous diabetic retinopathy baseline.
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_aptos2019_resnet50.pt"):
...
# =======================
def main():
    print("Starting APTOS2019 ResNet50 Baseline...")
    ...
    print(f"[INFO] Calculated class weights: {class_weights_tensor.cpu().numpy()}")
    ...
    best_path = "best_aptos2019_resnet50.pt"
    ...
    print("\nAPTOS2019 ResNet50 baseline + Weighted CrossEntropy completed!")
