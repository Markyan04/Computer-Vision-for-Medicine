...
"""
APTOS 2019 Blindness Detection baseline using ResNet50 + MECS (After Layer3) + DAST.
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_aptos2019_resnet50_mecs_layer3_DAST.pt"):
...
def main():
    ...
    # 修改了保存的文件名以防止覆盖
    best_path = "best_aptos2019_resnet50_mecs_layer3_DAST.pt"
    ...
    print("\nAPTOS2019 ResNet50 + MECS (Layer3) + DAST baseline completed!")
