...
"""
APTOS 2019 Blindness Detection baseline using ResNet50 and Standard CE.
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_aptos2019_resnet50_CE.pt"):
...
# =======================
def main():
    print("Starting APTOS2019 ResNet50 Baseline (Standard CE)...")
    ...
    # ===== Changed: Removed Class Weights, using Standard CrossEntropyLoss =====
    ...
    best_path = "best_aptos2019_resnet50_CE.pt"
    ...
    print("\nAPTOS2019 ResNet50 baseline + Standard CrossEntropy completed!")
