...
"""
APTOS 2019 Blindness Detection baseline using ResNet50 + MECS (After Layer2) + CrossEntropy.
Adapted from the GCSA baseline.
...
- Custom insertion of MECS_VersionA module after layer2
...
# =======================
# Custom Model with MECS
# =======================
class CustomResNet50WithMECS(nn.Module):
    def __init__(self, num_classes=5, pretrained=True):
        super(CustomResNet50WithMECS, self).__init__()
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_aptos2019_resnet50_mecs_layer2_CE.pt"):
...
# =======================
def main():
    print("Starting APTOS2019 CustomResNet50+MECS Baseline...")
    ...
    print("Loading CustomResNet50 with MECS module (After Layer2)...")
    # 使用包含 MECS 的自定义模型
    model = CustomResNet50WithMECS(num_classes=NUM_CLASSES, pretrained=True)
    ...
    best_path = "best_aptos2019_resnet50_mecs_layer2_CE.pt"
    ...
    print("\nAPTOS2019 ResNet50 + MECS (Layer2) + CrossEntropy baseline completed!")
