...
Adapted from the Standard CE baseline.
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_aptos2019_resnet50_DAST.pt"):
...
# =======================
def main():
    print("Starting APTOS2019 ResNet50 Baseline (DAST Loss)...")
    ...
    # ===== 核心修改处：换成 Distance-Aware Soft Target Loss =====
    ...
    # ===== 修改权重保存名 =====
    best_path = "best_aptos2019_resnet50_DAST.pt"
    ...
    print("\nAPTOS2019 ResNet50 baseline + DAST completed!")
