...
"""
APTOS 2019 Blindness Detection baseline using ResNet50 + MDFA (After Layer3) + CrossEntropy.
...
- Custom insertion of MDFA module after layer3
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_aptos2019_resnet50_mdfa_layer3_CE.pt"):
...
def main():
    ...
    best_path = "best_aptos2019_resnet50_mdfa_layer3_CE.pt"
    ...
    print("\nAPTOS2019 ResNet50 + MDFA (Layer3) + CrossEntropy baseline completed!")
