...
"""
APTOS 2019 Blindness Detection baseline using ResNet50 + MDFA (After Layer2) + CrossEntropy.
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_aptos2019_resnet50_mdf_layer2_CE.pt"):
...
def main():
    ...
    best_path = "best_aptos2019_resnet50_mdfa_CE.pt"
    ...
    print("\nAPTOS2019 ResNet50 + MDFA (Layer2) + CrossEntropy baseline completed!")
