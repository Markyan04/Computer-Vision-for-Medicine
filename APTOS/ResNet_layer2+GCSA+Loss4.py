...
"""
APTOS 2019 Blindness Detection baseline using ResNet50 + GCSA (After Layer2) + DAST.
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_aptos2019_resnet50_gcsa_layer2_DAST.pt"):
...
def main():
    ...
    # ===== 修改保存权重名称 =====
    best_path = "best_aptos2019_resnet50_gcsa_layer2_DAST.pt"
    ...
    print("\nAPTOS2019 ResNet50 + GCSA (Layer2) + DAST baseline completed!")
