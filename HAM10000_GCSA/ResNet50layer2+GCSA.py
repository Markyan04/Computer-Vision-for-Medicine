...
# -----------------------
class EarlyStopping:
    def __init__(self, patience=7, delta=0.0, save_path="isic_resnet50_gcsa_layer2_best.pt"):
...
class ResNet(nn.Module):
    def __init__(self, config, output_dim):
        ...
        self.gcsa = GCSA(in_channels=channels[1] * block.expansion, rate=4, groups=4)
...
# -----------------------
def main():
    print("Starting ISIC ResNet50 + GCSA (layer2).")
    ...
    params = [
        ...
        {"params": model.gcsa.parameters(), "lr": FOUND_LR / 4},
    ...
    best_path = "isic_resnet50_gcsa_layer2_best.pt"
    ...
    print("\nISIC ResNet50 + GCSA (layer2) completed!")
