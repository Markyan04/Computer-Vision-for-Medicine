...
"""
Brain Tumor MRI Baseline using ResNet50 + MDFA(after layer2)
...
class EarlyStopping:
    def __init__(self, patience=8, delta=0.0, loss_delta=1e-4,
                 save_path="best_resnet50_mdfa_layer2_brain_mri.pt"):
...
class ResNet50_MDFA_Layer2(nn.Module):
    def __init__(self, num_classes=4, mdfa_reduction=2):
        ...
        self.mdfa = MDFA(dim_in=512, dim_out=512, reduction=mdfa_reduction)
...
# =======================
def main():
    print("Starting Brain Tumor MRI ResNet50 + MDFA(after layer2)...")
    ...
    best_path = "best_resnet50_mdfa_layer2_brain_mri.pt"
    ...
    print("\nBrain Tumor MRI ResNet50 + MDFA(after layer2) completed!")
