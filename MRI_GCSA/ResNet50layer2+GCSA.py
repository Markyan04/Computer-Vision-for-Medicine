...
"""
Brain Tumor MRI Baseline using ResNet50 + GCSA (after layer2)
...
class ResNet50_GCSA_Layer2(nn.Module):
    def __init__(self, num_classes, weights=models.ResNet50_Weights.DEFAULT, gcsa_rate=4, gcsa_groups=4):
        ...
        self.gcsa = GCSA(in_channels=512, rate=gcsa_rate, groups=gcsa_groups)
...
# =======================
def main():
    print("Starting Brain Tumor MRI ResNet50 + GCSA (after layer2)...")
    ...
    best_path = "best_resnet50_gcsa_layer2_brain_mri.pt"
