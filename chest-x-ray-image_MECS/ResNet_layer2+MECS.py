...
"""
Chest X-ray ResNet50 + MECS (inserted after layer2)
...
# =======================
class EarlyStopping:
    def __init__(self, patience=7, delta=0.0, save_path="best_resnet50_mecs_layer2_chest_xray.pt"):
...
class ResNet50_MECS_Layer2(nn.Module):
    def __init__(self, num_classes, weights=models.ResNet50_Weights.DEFAULT):
        ...
        # 在 layer2 后插入 MECS，layer2的输出通道数是 512
...
# =======================
def main():
    print("Starting Chest X-ray ResNet50 + MECS(layer2) ...")
    ...
    model = ResNet50_MECS_Layer2(num_classes=num_classes).to(device)
    ...
    best_path = "best_resnet50_mecs_layer2_chest_xray.pt"
    ...
    print("\nChest X-ray ResNet50 + MECS(layer2) completed!")
