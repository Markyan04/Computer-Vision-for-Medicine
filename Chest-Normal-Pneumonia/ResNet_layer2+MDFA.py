...
"""
Chest X-ray Pneumonia using ResNet50 + MDFA(after layer2)
...
# =======================
class EarlyStopping:
    def __init__(self, patience=7, delta=0.0, loss_delta=1e-4, save_path="best_resnet50_mdfa_layer2_pneumonia.pt"):
...
class ResNet50_MDFA_Layer2(nn.Module):
    def __init__(self, num_classes, weights=models.ResNet50_Weights.DEFAULT):
        ...
        # ResNet50: layer2 输出通道是 512
        self.mdfa = MDFA(dim_in=512, dim_out=512, rate=1, reduction=2)
...
# =======================
def main():
    print("Starting Chest X-ray Pneumonia ResNet50 + MDFA(layer2) ...")
    ...
    print("Loading pretrained ResNet50 + inserting MDFA after layer2...")
    ...
    best_path = "best_resnet50_mdfa_layer2_pneumonia.pt"
    ...
    print("\nChest X-ray Pneumonia ResNet50 + MDFA(layer2) completed!")
