...
"""
ISIC (HAM10000) Baseline using ResNet50 + MECS(after layer1)
...
class ResNet(nn.Module):
    def __init__(self, config, output_dim):
        ...
        # layer1 后接 MECS
        self.mecs = MECS(block.expansion * channels[0], block.expansion * channels[0])
...
# -----------------------
def main():
    print("Starting ISIC ResNet50 + MECS(layer1) ...")
    ...
    # 这里仍然先加载 torchvision 的 resnet50 预训练参数
    ...
    best_path = "isic_resnet50_mecs_layer1_best.pt"
    ...
    print("\nISIC ResNet50 + MECS(layer1) completed!")
