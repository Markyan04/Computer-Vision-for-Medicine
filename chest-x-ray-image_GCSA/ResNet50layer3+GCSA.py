...
"""
Chest X-ray Baseline using ResNet50 + GCSA(after layer3)
Directory structure:
dataset_root/
├── train/
│   ├── COVID19/
...
# =======================
class ResNet50_GCSA_L3(nn.Module):
...
# =======================
class EarlyStopping:
    def __init__(self, patience=7, delta=0.0, save_path="best_resnet50_gcsa_l3_chest_xray.pt"):
...
# =======================
def main():
    print("Starting Chest X-ray ResNet50 + GCSA(layer3) ...")
    ...
    model = ResNet50_GCSA_L3(num_classes=num_classes).to(device)
    ...
    best_path = "best_resnet50_gcsa_layer3_chest_xray.pt"
    ...
    print("\nChest X-ray ResNet50 + GCSA(layer3) completed!")
