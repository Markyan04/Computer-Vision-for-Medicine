...
"""
Chest X-ray Pneumonia using ResNet50 + MECS (after layer2)
...
class ResNet50_MECS_Layer2(nn.Module):
    def __init__(self, num_classes, weights=models.ResNet50_Weights.DEFAULT):
        ...
        # MECS inserted after layer2
        self.mecs = MECS(in_channels=512, out_channels=512, channel_attention_reduce=4)
...
# =======================
def main():
    print("Starting Chest X-ray Pneumonia ResNet50 + MECS(layer2) ...")
    ...
    print("Loading pretrained ResNet50 + MECS(after layer2)...")
    ...
    best_path = "best_resnet50_mecs_layer2_pneumonia.pt"
    ...
    print("\nChest X-ray Pneumonia ResNet50 + MECS(layer2) completed!")
