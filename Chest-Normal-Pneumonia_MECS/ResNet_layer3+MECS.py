...
"""
Chest X-ray Pneumonia using ResNet50 + MECS (after layer3)
...
class ResNet50_MECS_Layer3(nn.Module):
    def __init__(self, num_classes, weights=models.ResNet50_Weights.DEFAULT):
        ...
        # MECS inserted after layer3
        self.mecs = MECS(in_channels=1024, out_channels=1024, channel_attention_reduce=4)
...
# =======================
class EarlyStopping:
    def __init__(self, patience=7, delta=0.0, loss_delta=1e-4, save_path="best_resnet50_mecs_layer3.pt"):
...
# =======================
def main():
    print("Starting Chest X-ray Pneumonia ResNet50 + MECS(layer3) ...")
    ...
    print("Loading pretrained ResNet50 + MECS(after layer3)...")
    ...
    best_path = "best_resnet50_mecs_layer3_pneumonia.pt"
    ...
    print("\nChest X-ray Pneumonia ResNet50 + MECS(layer3) completed!")
