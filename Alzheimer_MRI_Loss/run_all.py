...
"""
Batch runner for Alzheimer_MRI_Loss experiments.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run one or more Alzheimer_MRI_Loss experiment scripts."
    )
    parser.add_argument(
        "scripts",
        nargs="*",
        help="Optional script names to run. Defaults to the built-in scripts.",
    )
    parser.add_argument(
        "--losses",
        default="",
        help="Comma-separated loss names to run, e.g. 'ce,dast'. Defaults to script default.",
    )
