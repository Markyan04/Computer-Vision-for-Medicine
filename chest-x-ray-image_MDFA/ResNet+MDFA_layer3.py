...
"""
Chest X-ray ResNet50 + MDFA (inserted after layer3)
...
# =======================
class EarlyStopping:
    def __init__(self, patience=7, delta=0.0, save_path="best_resnet50_mdfa_layer3_chest_xray.pt"):
...
# =======================
def main():
    print("Starting Chest X-ray ResNet50 + MDFA(layer3)...")
    ...
    best_path = "best_resnet50_mdfa_layer3_chest_xray.pt"
    ...
    print("\nChest X-ray ResNet50 + MDFA(layer3) completed!")
