...
"""
Diabetic Retinopathy Detection Baseline using ResNet50 + MECS (Layer3) + CE
...
# =======================
def main():
    print("Starting Diabetic Retinopathy ResNet50 + MECS (Layer 3) + CrossEntropy Baseline...")
    ...
    best_path = "best_resnet50_dr_mecs_layer3_ce_patient_split.pt"
    ...
    print("\nDiabetic Retinopathy ResNet50 + MECS (Layer 3) + CrossEntropy baseline completed!")
