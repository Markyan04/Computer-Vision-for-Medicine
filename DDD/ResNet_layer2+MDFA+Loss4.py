...
"""
Diabetic Retinopathy Detection Baseline using ResNet50 + MDFA (After Layer2) + Loss4 (DAST)
...
# =======================
def main():
    print("Starting Diabetic Retinopathy ResNet50 + MDFA + Loss4 (DAST) Baseline (Patient-level split)...")
    ...
    best_path = "best_resnet50_dr_mdfa_loss4_patient_split.pt"
    ...
    print("\nDiabetic Retinopathy ResNet50 + MDFA + Loss4 baseline completed!")
