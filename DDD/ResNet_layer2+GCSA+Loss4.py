...
"""
Diabetic Retinopathy Detection Baseline using ResNet50 + GCSA (Layer2) + Loss4 (DAST)
...
# =======================
def main():
    print("Starting Diabetic Retinopathy ResNet50 + GCSA (Layer2) + Loss4 (DAST) Baseline...")
    ...
    for name, param in model.named_parameters():
        # 将分类头 (fc) 和新初始化的 GCSA 模块 (gcsa) 都放入 head_params 中，使用较大的学习率
    ...
    # 更改了保存路径以作区分
    best_path = "best_resnet50_dr_gcsa_layer2_loss4_patient_split.pt"
    ...
    print("\nDiabetic Retinopathy ResNet50 + GCSA (Layer2) + Loss4 baseline completed!")
