...
"""
Diabetic Retinopathy Detection Baseline using ResNet50 + MECS (Layer2) + Loss4 (DAST)
...
# =======================
def main():
    print("Starting Diabetic Retinopathy ResNet50 + MECS (Layer 2) + Loss4 Baseline...")
    ...
    best_path = "best_resnet50_dr_mecs_layer2_loss4_patient_split.pt"
    ...
    print("\nDiabetic Retinopathy ResNet50 + MECS (Layer 2) + Loss4 baseline completed!")
