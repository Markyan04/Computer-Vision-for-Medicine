...
"""
Diabetic Retinopathy Detection Baseline using ResNet50 + GCSA (Layer3) + Loss4 (DAST)
...
- GCSA module inserted after layer3 (channels=1024)
...
# =======================
# Custom Model: ResNet50 + GCSA (After Layer3)
# =======================
class ResNet50_GCSA_Layer3(nn.Module):
    def __init__(self, num_classes=5):
        super(ResNet50_GCSA_Layer3, self).__init__()
        # 1. 加载预训练的 ResNet50
        ...
        # 3. 插入 GCSA 模块 (ResNet50 layer3 输出通道数为 1024)
    ...
    def forward(self, x):
        ...
        # 在 layer3 和 layer4 之间通过 GCSA 模块
        x = self.gcsa(x)
...
# =======================
def main():
    print("Starting Diabetic Retinopathy ResNet50 + GCSA (Layer3) + Loss4 (DAST) Baseline...")
    ...
    print("Loading pretrained ResNet50 and injecting GCSA after layer3...")
    model = ResNet50_GCSA_Layer3(num_classes=num_classes)
    ...
    # 更改了保存路径以作区分
    best_path = "best_resnet50_dr_gcsa_layer3_loss4_patient_split.pt"
    ...
    print("\nDiabetic Retinopathy ResNet50 + GCSA (Layer3) + Loss4 baseline completed!")
