...
"""
Diabetic Retinopathy Detection Baseline using ResNet50 + MDFA (After Layer3) + Loss4 (DAST)
...
# =======================
def main():
    print("Starting Diabetic Retinopathy ResNet50 + MDFA (Layer3) + Loss4 (DAST) Baseline...")
    ...
    # 更改了保存路径以作区分
    best_path = "best_resnet50_dr_mdfa_layer3_loss4_patient_split.pt"
    ...
    print("\nDiabetic Retinopathy ResNet50 + MDFA (Layer3) + Loss4 baseline completed!")
