...
"""
Diabetic Retinopathy Detection Baseline using ResNet50 + MDFA (After Layer2) + CrossEntropy
...
- MDFA module inserted after layer2
...
# =======================================================
# 注释掉医用损失函数库中的 DistanceAwareSoftTargetLoss
# =======================================================
...
# =======================
# Custom Model: ResNet50 + MDFA
# =======================
class ResNet50_MDFA(nn.Module):
    def __init__(self, num_classes=5):
        super(ResNet50_MDFA, self).__init__()
        # 1. 加载预训练的 ResNet50
        ...
        # 3. 插入 MDFA 模块 (ResNet50 layer2 输出通道数为 512)
    ...
    def forward(self, x):
        ...
        # 在 layer2 和 layer3 之间通过 MDFA 模块
        x = self.mdfa(x)
...
# =======================
def main():
    print("Starting Diabetic Retinopathy ResNet50 + MDFA + CrossEntropy Baseline (Patient-level split)...")
    ...
    print("Loading pretrained ResNet50 and injecting MDFA after layer2...")
    model = ResNet50_MDFA(num_classes=num_classes)
    ...
    best_path = "best_resnet50_dr_mdfa_ce_patient_split.pt"
    ...
    print("\nDiabetic Retinopathy ResNet50 + MDFA + CrossEntropy baseline completed!")
