...
"""
Diabetic Retinopathy Detection Baseline using ResNet50
...
# =======================
class EarlyStopping:
    def __init__(self, patience=10, delta=0.0, save_path="best_resnet50_dr.pt"):
...
# =======================
def main():
    print("Starting Diabetic Retinopathy ResNet50 Baseline (Patient-level split)...")
    ...
    best_path = "best_resnet50_dr_patient_split.pt"
    ...
    print("\nDiabetic Retinopathy ResNet50 baseline completed!")
