...
"""
Diabetic Retinopathy Detection Baseline using ResNet50 + GCSA (Layer2) + CE
...
- GCSA module inserted after layer2 (channels=512)
...
# =======================
# Custom Model: ResNet50 + GCSA (After Layer2)
# =======================
class ResNet50_GCSA_Layer2(nn.Module):
    def __init__(self, num_classes=5):
        super(ResNet50_GCSA_Layer2, self).__init__()
        # 1. 加载预训练的 ResNet50
        ...
        # 3. 插入 GCSA 模块 (ResNet50 layer2 输出通道数为 512)
        self.gcsa = GCSA(in_channels=512)
    ...
    def forward(self, x):
        ...
        # 在 layer2 和 layer3 之间通过 GCSA 模块
        x = self.gcsa(x)
...
# =======================
def main():
    print("Starting Diabetic Retinopathy ResNet50 + GCSA (Layer2) + CrossEntropy Baseline...")
    ...
    print("Loading pretrained ResNet50 and injecting GCSA after layer2...")
    model = ResNet50_GCSA_Layer2(num_classes=num_classes)
    ...
    # 修改为 CE
    best_path = "best_resnet50_dr_gcsa_layer2_ce_patient_split.pt"
    ...
    print("\nDiabetic Retinopathy ResNet50 + GCSA (Layer2) + CrossEntropy baseline completed!")
